...
class DeviceView extends PowerView {
	...
	function onUpdate(dc) {
	   ...
	   if (uShowDemo == false ) {
		...
		for (var i = 1; i < 7; ++i) {
	    	if ( i == 1 ) {			//!upper row, left
	    		...
	    		Formatting(dc,i,fieldValue[i],fieldFormat[i],fieldLabel[i],"082,113,090,018,124,011,130");
	   ...
	   //! Display demo screen
		...
		if (licenseOK == true) {
      		dc.drawText(109, 36, Graphics.FONT_XTINY, "DR6c1", Graphics.TEXT_JUSTIFY_CENTER|Graphics.TEXT_JUSTIFY_VCENTER);
